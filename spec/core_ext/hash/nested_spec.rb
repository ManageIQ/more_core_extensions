...
describe Hash do
  ...
  shared_examples_for "will not modify arguments" do |meth|
  ...
  context '#fetch_path' do
    ...
    include_examples "will not modify arguments", :fetch_path
  end
  ...
  context "#store_path" do
    ...
    include_examples "will not modify arguments", :store_path
  end
  ...
  context '#has_key_path?' do
    ...
    include_examples "will not modify arguments", :has_key_path?
  end

  context "#delete_path" do
    include_examples "will not modify arguments", :delete_path
  end
end
